...
from fonctions.analyse.graphs_analyse import graph_eval_all_peaks
from fonctions.analyse.fichiers import lecture_df
...
def distribution_peaks(): 
    ...
    peak_values = df_summary[VALOBS_ALL_PEAKS]  
